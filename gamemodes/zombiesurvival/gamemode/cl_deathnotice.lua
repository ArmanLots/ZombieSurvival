...
killicon.Add("prop_gunturret_pulse", "zombiesurvival/killicons/weapon_zs_gunturret2")
...
killicon.Add("weapon_zs_gunturret_pulse", "zombiesurvival/killicons/weapon_zs_gunturret2")
