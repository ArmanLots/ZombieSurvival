...
killicon.Add("prop_gunturret_pluse", "zombiesurvival/killicons/weapon_zs_gunturret2")
...
killicon.Add("weapon_zs_gunturret_pluse", "zombiesurvival/killicons/weapon_zs_gunturret2")
