...
LANGUAGE.need_to_be_near_arsenal_crate				= "You need to be near an Sigil or Arsenal Crate to purchase items!"
...
LANGUAGE.description_frost_headcrab     = "A unique type of headcrab, capable of giving bleed and frost to humans while also be quite sturdy"
LANGUAGE.description_marrow_mutant      = "A redmarrow that undergone violent mutations making it by far the strongest kind\nthe Marrow Mutant can let out a resurgence scream, healing nearby zombies"
...
LANGUAGE.description_drencher           = "A being worth avoiding, This brute has greatly mutated blood cells\ngiving it superior strength and making it extremely hard to put down.\nUpon it's death, it guts explode into a violent blood storm, greatly damaging structures and humans nearby."
...
LANGUAGE.controls_fast_zombie_slingshot				= "> PRIMARY: Bleeding Claws\n> SECONDARY: Slingshot / Climb wall\n> RELOAD: Scream\n> ON SLINGSHOT HUMAN: Slow"
...
LANGUAGE.zclasses_semibosses      = "Demibosses"
LANGUAGE.zclasses_semibosses_d    = "Demibosses - Demiboss zombies are as half powerful as boss zombies, but some of them still have good abilities.\nHealth increased by 10 per player."
...
LANGUAGE.controls_howler    							        = "> PRIMARY: Claws\n> SECONDARY: Howl\n> RELOAD: Moan"
LANGUAGE.class_lacerator_charging_deadly			  	= "Flesh Breaker"
LANGUAGE.description_lacerator_charging_deadly		= "A unique type of charger. It can use it's thick armor to block heavy damage while charging\nHas increased max charge time and -70% damage taken while charging."
