CLASS.Name = "Magic Shade"
CLASS.TranslationName = "class_magic_shade"
CLASS.Description = "description_magic_shade"
CLASS.Help = "controls_magic_shade"
...
CLASS.SWEP = "weapon_zs_magicshade"
