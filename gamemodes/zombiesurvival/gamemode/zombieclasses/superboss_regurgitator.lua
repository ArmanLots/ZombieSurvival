CLASS.Name = "Regurgitator"
CLASS.TranslationName = "class_regurgitator"
CLASS.Description = "description_regurgitator"
CLASS.Help = "controls_regurgitator"
