CLASS.Name = "Obliterator"
CLASS.TranslationName = "class_obliterator"
CLASS.Description = "description_obliterator"
CLASS.Help = "controls_obliterator"
...
CLASS.SWEP = "weapon_zs_obliterator"
...
CLASS.IconColor = Color(30, 30, 30)

local function CreateBoneOffsets(pl)
	pl.m_NightmareBoneOffsetsNext = CurTime() + math_Rand(0.01, 0.1)
